...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Next two lines sets it back in windowed but must comment out upper three lines.
    ...
    def _create_fleet(self):
        ...
        # Spacing between each alien is one equal to one alien width.
        alien = Alien(self)
    ...
    def _check_fleet_edges(self):
        '''Respond appropriately id any aliens have reached an edge.'''
    ...
    def _change_fleet_direction(self):
        ...
        self.settings.fleet_direction *= -1
            ...
            # Watch to keypresses and mouse events.
